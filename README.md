...
## Usage:
Download and extract, open terminal, `cd` to the extracted folder, and execute `./kvmswitch`. SIf desired, set up a [keyboard shortcut](#keyboard-shortcut) for hotkey support.
## Keyboard shortcut:
